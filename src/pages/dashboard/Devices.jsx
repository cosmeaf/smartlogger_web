        ...
        <table className="min-w-full bg-white">
          <thead className="bg-blue-900 text-white">
            <tr>
              ...
              <th className="w-1/6 text-left py-3 px-4 uppercase font-semibold text-sm">Data Dispositivo</th>
              <th className="w-1/6 text-left py-3 px-4 uppercase font-semibold text-sm">Última Atualizaçao</th>
